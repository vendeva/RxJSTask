...
Функции реализованы в порядке заданного ТЗ. Дополнительно для наглядной работы функции resolveCancelRequest приведена функция testResolveCancelRequest с похожей реализацией для тестирования ответов через заданные промежутки времени и определения от какого промежутка принят итоговый ответ (см. работу в консоли браузера)
